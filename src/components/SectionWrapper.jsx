...
const SectionWrapper = ({ sections, isFirstLoad }) => {
  const renderSectionContent = (id) => {
    switch (id) {
      case '00': return <HeroSection isFirstLoad={isFirstLoad} />;
      case '01': return <HelloSection />;
      case '02': return <ApproachSection />;
      case '03': return <WorkSection />;
      case '04': return <TalentSection />;
      case '05': return <CareersSection />;
      case '06': return <ContactSection />;
      case '07': return (
